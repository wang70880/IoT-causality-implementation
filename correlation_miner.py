    ...
    def policy_specification(self, effects_dict):
        ...
        for cause_attr in effects_dict.keys():
            for outcome_attr in effects_dict[cause_attr].keys():
                if (effects_dict[cause_attr][outcome_attr][1] > 0.5 and effects_dict[cause_attr][outcome_attr][0] > 0.5) or (effects_dict[cause_attr][outcome_attr][1] <= 0.5 and effects_dict[cause_attr][outcome_attr][0] <= 0.5):
                    count += 1
